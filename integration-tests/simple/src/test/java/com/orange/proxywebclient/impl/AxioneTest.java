...
public class AxioneTest {
  ...
  public void testPartnerImplementation() {
    ...
    config.put("tokenUrl", server.baseUrl() + "/axione/token");
    config.put("clientId", "e-intervention");
    ...
    given()
        .when()
        .get("/proxy/axione/axione-api")
        .then()
        .statusCode(200)
        .body(is("OK for Axione method"));
  }
}
