...
public class AltitudeOsaTest {
  ...
  public void testValidation() {
    var partner =
        new Partner()
            ...
            .setClientId("altitudeOsa")
            .setMethod("AltitudeOsa");
  ...
  public void testPartnerImplementation() {
    ...
    config.put("tokenUrl", server.baseUrl() + "/altitudeOsa/token");
    ...
    given()
        .when()
        .get("/proxy/altitudeOsa/altitudeOsa-api")
        .then()
        .statusCode(200)
        .body(is("OK for AltitudeOsa method"));
  }
}
